...
namespace TinyECA
{
    public class Entity
    {
        ...
        internal void CallComponentMethod<T>(string methodName, object[] parameters) where T : EntityComponent
        {
        ...
        internal void CallComponentMethod<T>(string methodName) where T : EntityComponent => CallComponentMethod<T>(methodName, new object[] { });
